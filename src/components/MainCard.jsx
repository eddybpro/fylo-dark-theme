...
import { StayProductiveIllustration, ArrowIcon } from "../assets";
    ...
    <main>
      ...
      <div className="StayProductiveCard">
        ...
        <div className="StayProductiveCard-TxtBox">
          ...
          <div className="StayProductiveCard-TxtBox-LinkBox">
            <a href="#" className="StayProductiveCard-TxtBox-LinkBox-Link">
              See how Fylo works
            </a>
            <img
              src={ArrowIcon}
              alt=""
              className="StayProductiveCard-TxtBox-LinkBox-Arrow"
            />
          </div>
        </div>
      </div>
